...
# Transformations: LATERAL VIEW EXPLODE products, then LEFT JOIN with s_salesorders.products for category
# NOTE: EXPLODE must be in a subquery — Spark SQL does not allow JOIN after LATERAL VIEW in the same FROM
