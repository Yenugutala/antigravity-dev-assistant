...
## Purpose
Read pipeline specifications and auto-generate all artifacts for a Databricks Medallion Architecture pipeline (Bronze → Silver → Gold).

**Rules reference:** Follow all coding standards in `.claude/rules/` — do NOT duplicate them here.
...
- Follow `.claude/rules/bronze.md` and `.claude/rules/notebooks.md`
...
- Follow `.claude/rules/silver.md` and `.claude/rules/notebooks.md`
...
- Follow `.claude/rules/gold.md` and `.claude/rules/notebooks.md`
...
- Follow `.claude/rules/notebooks.md`
