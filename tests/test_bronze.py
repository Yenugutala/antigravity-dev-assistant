...
class TestSchemaFields:
    def test_products_schema_exists(self):
        assert hasattr(bronze, "product_schema")
        assert bronze.product_schema is not None

    def test_carts_schema_exists(self):
        assert hasattr(bronze, "cart_schema")
        assert bronze.cart_schema is not None

    def test_users_schema_exists(self):
        assert hasattr(bronze, "user_schema")
        assert bronze.user_schema is not None
